...
namespace DatabaseTask.Core.Domain
{
    public class Employee
    {
        ...
        public ICollection<HealthCheckList> HealthChecks { get; set; }
        public ICollection<PositionList> Position { get; set; }
        public ICollection<Child> Children {  get; set; }
        public ICollection<SickLeaveListID> SickLeaveLists { get; set; }
